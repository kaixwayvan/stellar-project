    ...
    <div style={containerStyle}>
      ...
      <nav style={navStyle}>
        ...
        <div style={navLinksStyle}>
          ...
          <small style={{ color: '#86868B', fontWeight: '500' }}>Stellar Testnet Live</small>
        </div>
      </nav>
      ...
      <section style={glassHeroStyle}>
        ...
        <p style={descriptionStyle}>
          Automate allowances on the Stellar Network. Securely lock funds with smart 
          time-release protocols designed for the next generation.
        </p>
      ...
      <div style={gridStyle}>
        {[
          { num: '01', title: 'The Wallet', desc: 'Install Freighter. Switch to Testnet.' },
          { num: '02', title: 'The Assets', desc: 'Hold XLM for Soroban smart contract fees.' },
          { num: '03', title: 'The Flow', desc: 'Set lock dates and release funds instantly.' }
        ].map((step, i) => (
      ...
      <footer style={footerStyle}>
        ...
        <p style={{ margin: 0 }}>Built for the Stellar Hackathon • Soroban Powered</p>
      </footer>
    </div>
  );
}
